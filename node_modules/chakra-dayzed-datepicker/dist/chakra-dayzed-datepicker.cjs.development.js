...
var DayOfMonth = function DayOfMonth(_ref) {
  ...
  var disabled = !selectable || (disabledDates == null ? void 0 : disabledDates.has(date.getTime()));
...
var CalendarPanel = function CalendarPanel(_ref) {
  ...
  return React__default["default"].createElement(react.Stack, _extends({
    ...
    return React__default["default"].createElement(react.VStack, {
    ...
    }), React__default["default"].createElement(react.Heading, _extends({
      size: "sm",
      minWidth: '5rem',
      textAlign: "center"
    }, propsConfigs == null ? void 0 : propsConfigs.dateHeadingProps), configs.monthNames[calendar.month], " ", calendar.year), React__default["default"].createElement(DatepickerForwardBtns, {
      calendars: calendars,
      ...
      return React__default["default"].createElement(react.Box, _extends({
        ...
        fontWeight: "semibold",
        key: dayIdx
      }, propsConfigs == null ? void 0 : propsConfigs.weekdayLabelProps), day);
...
var _excluded$1 = ["configs", "propsConfigs", "usePortal", "disabledDates", "defaultIsOpen", "closeOnSelect"];
