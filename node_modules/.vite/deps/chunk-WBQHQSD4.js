...
function updateMotionValuesFromProps(element, next, prev) {
  ...
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(nextValue.version === "10.12.17", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.12.17 may not work as expected.`);
      }
...
var ToastComponent = (0, import_react52.memo)((props) => {
  ...
  const toastStyle = (0, import_react52.useMemo)(() => getToastStyle(position), [position]);
  ...
  return {
    ...
    notify: (message, options) => {
      ...
      setState((prevToasts) => {
        ...
        const toasts = isTop ? [toast, ...(_a2 = prevToasts[position]) != null ? _a2 : []] : [...(_b = prevToasts[position]) != null ? _b : [], toast];
        return {
          ...prevToasts,
          [position]: toasts
        };
...
var variants = {
  exit: ({
    ...
    return {
      ...
      transition: (_a2 = transition == null ? void 0 : transition.exit) != null ? _a2 : withDelay.exit(defaultTransitions.exit, delay2)
    };
  },
  enter: ({
    animateOpacity,
    ...
    return {
      ...
      transition: (_a2 = transition == null ? void 0 : transition.enter) != null ? _a2 : withDelay.enter(defaultTransitions.enter, delay2)
    };
  }
};
...
var variants5 = {
  exit: ({ direction, transition, transitionEnd, delay: delay2 }) => {
    var _a2;
    const { exit: exitStyles } = getSlideTransition({ direction });
    return {
      ...exitStyles,
      transition: (_a2 = transition == null ? void 0 : transition.exit) != null ? _a2 : withDelay.exit(defaultTransition.exit, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit
    };
  },
  enter: ({ direction, transitionEnd, transition, delay: delay2 }) => {
    var _a2;
    const { enter: enterStyles } = getSlideTransition({ direction });
    return {
      ...enterStyles,
      transition: (_a2 = transition == null ? void 0 : transition.enter) != null ? _a2 : withDelay.enter(defaultTransition.enter, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.enter
    };
  }
};
var Slide = (0, import_react65.forwardRef)(function Slide2(props, ref) {
  ...
  const show = unmountOnExit ? isOpen && unmountOnExit : true;
  const animate2 = isOpen || unmountOnExit ? "enter" : "exit";
  const custom = { transitionEnd, transition, direction, delay: delay2 };
...
var useUpdateEffect2 = (effect4, deps) => {
...
// node_modules/@chakra-ui/skip-nav/dist/chunk-N4LNFUBI.mjs
...
var Tooltip = forwardRef((props, ref) => {
  ...
  const userDefinedBg = (_b = (_a2 = background != null ? background : backgroundColor) != null ? _a2 : bg) != null ? _b : bgColor;
  if (userDefinedBg) {
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-WBQHQSD4.js.map
